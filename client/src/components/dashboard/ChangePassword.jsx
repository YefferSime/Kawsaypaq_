    ...
    <div className='p-4 bg-white'>
        ...
        <form>
            <div className='flex flex-col gap-1 mb-2'>
                ...
                <input type="password" id='old_password' name='old_password' placeholder='Tu antigua contraseña...' className='outline-none px-3 py-1 border rounded-md text-slate-600' />
            </div>
            <div className='flex flex-col gap-1 mb-2'>
