    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Dirección : Santa Anita</li>
                            <li>Telefono : +51 951 534 535</li>
                            <li>Correo : kawsaypaq@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div className='w-5/12 lg:w-8/12 sm:w-full'>
                    <div className='flex justify-center sm:justify-start sm:mt-6 w-full'>
                        <div>
                            <h2 className='font-bold text-lg mb-2'>Otros links</h2>
                            <div className='flex justify-between gap-[80px] lg:gap-[40px]'>
                                <ul className='flex flex-col gap-2 text-slate-600 text-sm'>
                                    ...
                                    <li>
                                        <Link>Información del Delivery</Link>
                                    </li>
                                    <li>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        <h2 className='font-bold text-lg mb-2'>¡Unetenos!</h2>
                        <span>¡Estate al pendiente de nuestras ultimas ofertas especiales!</span>
                        <div className='h-[50px] w-full bg-white border relative'>
                            <input placeholder='Ingresa tu correo' className='h-full bg-transparent w-full px-3 outline-0' type="text" />
                            <button className='h-full absolute right-0 bg-indigo-500 text-white uppercase px-4 font-bold text-sm'>Suscribete</button>
                        </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copyright ©2024 All rights reserved | mady by <a className='text-blue-500 underline' href="">@Kawsaypaq</a></span>
            </div>
